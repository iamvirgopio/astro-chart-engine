...
async def _blend_ingredients_into_answer(ingredients, task_instruction, question_context=None, api_key=None, sentence_range="2-5", max_tokens=300, allow_web_search=False, interpretive=False, stylist_voice=False, model="claude-haiku-4-5-20251001"):
    ...
    system_prompt = (
        ...
        + (
            ...
            "says about you, and don't end with a line summarizing the whole look. Open by "
            ...
            "\"keep everything else quiet:\")\u2014use a plain sentence or an em dash instead, "
            "never a colon-led list structure. The test for every clause: does it name a new "
...
async def _cut_commentary(raw_text, api_key=None, model="claude-haiku-4-5-20251001"):
    ...
    system_prompt = (
        ...
        "base:\", \"keep everything else quiet:\") down to a plain sentence or an em dash, "
        "never a colon-led list. Watch specifically for a placement "
