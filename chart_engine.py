...
async def _blend_ingredients_into_answer(ingredients, task_instruction, question_context=None, api_key=None, sentence_range="2-5", max_tokens=300, allow_web_search=False, interpretive=False, stylist_voice=False, model="claude-haiku-4-5-20251001"):
    ...
    system_prompt = (
        ...
        + (
            ...
            "The same reasoning applies to color, not just shape: a placement described as "
            "\"dark and rich,\" for instance, spans a genuinely wide real range\u2014think "
            "forest green, aubergine, chocolate, ink navy, deep burgundy, espresso, wine, burnt "
            "umber, and many more, not just black or one or two go-to words. Cycling through "
            "the same three or four colors across different requests, a real, reported "
            "failure, is the same underlying problem as reusing the same garment shape\u2014"
            "reach for the real, much wider range every time, genuinely thought through rather "
            "than defaulted to.\n\n"
